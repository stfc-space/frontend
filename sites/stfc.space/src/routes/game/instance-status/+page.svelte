...
<div bind:clientWidth={containerWidth}>
  ...
  <div class="grid gap-3 grid-cols-3 mb-4 grid-flow-dense">
    {#each filteredInstances as instance (instance.id)}
      <div
        class="flex items-center p-2 rounded-lg shadow bg-dark-500 flex-wrap"
        on:click={() => {
      ...
      >
        <div class="w-full">
          <div class="flex items-center gap-0.5">
            ...
            <span class="inline-block text-gray-200 text-sm">
            ...
            <div class="ml-auto px-2 py-2">
              ...
              {:else if instance.status == Status.Incident}
                <span
                  class="border border-red-500 text-red-500 px-1 py-0.5 rounded dark:bg-dark-900"
                >
                  {$_('status.incident')}
                </span>
